...
# Output: list = ['first entry', 'second entry', 'third entry', range(0, 3), 0, 1, 2, 'a', 'b', 'c']
print(f"list = {list}")

# Output: index of element 'third entry': 2
...
# Output: list = ['first entry', 'second entry', 'third entry', 0, 1, 2]
print(f"list = {list}")
